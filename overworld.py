...
class Icon(pygame.sprite.Sprite):
    def __init__(self, pos):
        super().__init__()
        self.pos = pos
        self.frames = import_folder('graphics/overworld/icon')
        self.frame_index = 0
        self.image = self.frames[self.frame_index]
        self.rect = self.image.get_rect(center=pos)
...
class Overworld():
    ...
    def input(self):
        if not self.moving and self.allow_input:
            ...
            if keys[pygame.K_RIGHT] and self.current_level < self.max_level:
                ...
                player_ref = [0,0,0,0,0,0]
                self.create_level(self.current_level, player_ref)
    ...
    def run(self):
        ...
        self.sky.draw(self.display_surface,0)
        self.draw_paths()
